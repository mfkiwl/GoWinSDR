module gw_gao(
    ...
    \u_rf_data_processor/fifo_wr_data[7] ,
    \u_rf_data_processor/fifo_wr_data[6] ,
    \u_rf_data_processor/fifo_wr_data[5] ,
    \u_rf_data_processor/fifo_wr_data[4] ,
    \u_rf_data_processor/fifo_wr_data[3] ,
    \u_rf_data_processor/fifo_wr_data[2] ,
    \u_rf_data_processor/fifo_wr_data[1] ,
    \u_rf_data_processor/fifo_wr_data[0] ,
...
input \u_rf_data_processor/fifo_wr_data[7] ;
input \u_rf_data_processor/fifo_wr_data[6] ;
input \u_rf_data_processor/fifo_wr_data[5] ;
input \u_rf_data_processor/fifo_wr_data[4] ;
input \u_rf_data_processor/fifo_wr_data[3] ;
input \u_rf_data_processor/fifo_wr_data[2] ;
input \u_rf_data_processor/fifo_wr_data[1] ;
input \u_rf_data_processor/fifo_wr_data[0] ;
...
wire \u_rf_data_processor/fifo_wr_data[7] ;
wire \u_rf_data_processor/fifo_wr_data[6] ;
wire \u_rf_data_processor/fifo_wr_data[5] ;
wire \u_rf_data_processor/fifo_wr_data[4] ;
wire \u_rf_data_processor/fifo_wr_data[3] ;
wire \u_rf_data_processor/fifo_wr_data[2] ;
wire \u_rf_data_processor/fifo_wr_data[1] ;
wire \u_rf_data_processor/fifo_wr_data[0] ;
