...
(
    input wire          clk         ,
    input wire          rst_n       ,
    input wire  [11:0]  data_in_I_12   ,
    input wire  [11:0]  data_in_Q_12   ,
...
wire [14:0] data_in_I = {data_in_I_12[11:0],3'b000};
wire [14:0] data_in_Q = {data_in_Q_12[11:0],3'b000};
    ...
    Gowin_MULT  mult_interploate_f1_1_I(
        .dout(mult_result_f1_1_I),  // output [32:0] dout
        .a(f1_I),                   // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
    ...
    Gowin_MULT  mult_interploate_f1_2_I(
        .dout(mult_result_f1_2_I),  // output [32:0] dout
        .a(mult_result_f1_1_I[31:15]), // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
        .reset(~rst_n)              // input reset
    ...
    Gowin_MULT  mult_interploate_f2_1_I(
        .dout(mult_result_f2_1_I),  // output [32:0] dout
        .a(f2_I),                   // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
    ...
    Gowin_MULT  mult_interploate_f1_1_Q(
        .dout(mult_result_f1_1_Q),  // output [32:0] dout
        .a(f1_Q),                   // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
    ...
    Gowin_MULT  mult_interploate_f1_2_Q(
        .dout(mult_result_f1_2_Q),  // output [32:0] dout
        .a(mult_result_f1_1_Q[31:15]), // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
        .reset(~rst_n)              // input reset
    ...
    Gowin_MULT  mult_interploate_f2_1_Q(
        .dout(mult_result_f2_1_Q),  // output [32:0] dout
        .a(f2_Q),                   // input [16:0] a
        .b(uk),                     // input [15:0] b
        .clk(clk),                  // input clk
        .ce(1'b1),                  // input ce
